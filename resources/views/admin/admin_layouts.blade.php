...
<html lang="en">
  ...
  @else
 <!-- ########## START: LEFT PANEL ########## -->
 <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Inson.net</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('create.post') }}" class="nav-link">Add post</a></li>
          <li class="nav-item"><a href="{{ route('all.posts') }}" class="nav-link">All posts</a></li>
        </ul>
